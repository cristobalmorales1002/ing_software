...
const UserDetails = () => {
    ...
    // Estado para manejar el feedback visual de "Copiado"
    // Puede ser: null, 'email', 'phone'
    ...
    const copyToClipboard = (text, field) => {
        ...
        // Resetear el icono después de 2 segundos
        setTimeout(() => {
            setCopiedField(null);
        }, 2000);
    };
    ...
    const renderContent = () => {
        ...
        if (error || !user) return (
            <Alert variant="danger" className="mb-4">
                ...
                <div className="mt-2">
                    <Button variant="outline-danger" size="sm" onClick={() => navigate(-1)}>Volver</Button>
                </div>
            </Alert>
        );
        ...
        return (
            <>
                ...
                <div className="d-flex align-items-center gap-3 mb-4">
                    ...
                    <h2 className="mb-0 fw-bold text-dark">PERFIL DE USUARIO</h2>
                </div>
                    ...
                    <Col md={4}>
                        <Card className="h-100 shadow-sm border-0 overflow-hidden">
                            ...
                            <Card.Body className="text-center pt-0 position-relative">
                                ...
                                <h3 className="fw-bold mb-1 text-dark">{user.nombres || user.nombre} {user.apellidos}</h3>
                                ...
                                <div className="d-flex justify-content-center">
                                    <div className="d-flex align-items-center gap-2 px-3 py-2 bg-light rounded-pill border">
                                        ...
                                        <span className="fw-bold text-secondary small">ID #{user.usuarioId || user.id}</span>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Col md={8}>
                        <Card className="shadow-sm border-0 h-100">
                            <Card.Header className="bg-white py-3 border-bottom-0">
                                <h5 className="mb-0 fw-bold text-secondary">Información de Contacto</h5>
                            </Card.Header>
                            <Card.Body className="pt-0 pb-4 px-4 d-flex flex-column gap-4">

                                {/* EMAIL SECTION */}
                                <div className="p-3 border rounded bg-light bg-opacity-25 transition-hover">
                                    <div className="d-flex justify-content-between align-items-center mb-2">
                                        <div className="d-flex align-items-center gap-2">
                                            <Envelope className="text-primary fs-5"/>
                                            <span className="fw-bold text-secondary text-uppercase small">Correo Electrónico</span>
                                        </div>
                                    </div>

                                    <div className="d-flex align-items-center justify-content-between bg-white border rounded p-2 ps-3">
                                        <span className={`text-break fw-medium ${!user.email ? 'text-muted fst-italic' : 'text-dark'}`}>
                                ...
                                <div className="p-3 border rounded bg-light bg-opacity-25 transition-hover">
                                    <div className="d-flex justify-content-between align-items-center mb-2">
                                        <div className="d-flex align-items-center gap-2">
                                            ...
                                            <span className="fw-bold text-secondary text-uppercase small">Teléfono</span>
                                        </div>
                                    </div>

                                    <div className="d-flex align-items-center justify-content-between bg-white border rounded p-2 ps-3">
                                        <span className={`fw-medium ${!user.telefono ? 'text-muted fst-italic' : 'text-dark'}`}>
